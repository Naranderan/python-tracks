...
def check_drinks(drink_name, drink_ingredients):
    ...
    contains_alocholic_ingredient = ALCOHOLS & set(drink_ingredients)
    return drink_name + ' Cocktail' if contains_alocholic_ingredient else drink_name + ' Mocktail'
...
def compile_ingredients(dishes):
    ...
    master_ingredients_list = set()
    for dish_ing in dishes:
         master_ingredients_list |= dish_ing
...
def separate_appetizers(dishes, appetizers):
    ...
    return sorted(set(dishes) - set(appetizers))
